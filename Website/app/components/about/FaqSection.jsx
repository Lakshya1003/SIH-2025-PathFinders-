...
export default function FaqSection() {
  return (
    <div className="mt-0 rounded-b-lg border-x border-b bg-white p-6">
      ...
      <p className="text-sm text-gray-500">Find answers to common questions about CampusOne</p>
      ...
      <div className="mt-6 space-y-4">
        ...
        <FaqItem
          ...
          answer="Yes, CampusOne fully supports multiple teachers teaching different subjects in the same class. When adding teachers, you can specify which subjects they teach in which classes. This flexibility allows for specialized subject teaching while maintaining clear organization in the system."
        />
        <FaqItem
        ...
        />
        <FaqItem
          question="Is there a mobile app available for CampusOne?"
        ...
        <FaqItem
          ...
          answer="Yes, CampusOne offers various customization options. You can configure class structures, attendance categories, grading systems, and more according to your school's requirements. For more advanced customizations, please contact our support team."
        />
        <FaqItem
          question="Is my data secure on CampusOne?"
